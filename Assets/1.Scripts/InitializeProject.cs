...
public class StopPlaymode
{
    ...
    static void DeleteSelfScript()
    {
        ...
        static void CreateFolders()
        {
            ...
            {
                if (!Directory.Exists(assetsFolder + "/_Project" + " / " + folder))
                {
                    Directory.CreateDirectory(assetsFolder+ "/_Project"  + "/" + folder);
                }
            }
        }
